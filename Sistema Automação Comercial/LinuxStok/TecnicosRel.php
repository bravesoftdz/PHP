...
?>
<title>Ver Relatório de Técnicos</title>
</head>
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><div align="right"><strong class="sub_titulo_artigo_detalhes">MjERP 1.0</strong><br />
      ...
      ERP <a href="TecnicosList.php">Voltar</a><br />
  ...
  <tr>
    ...
    <td height="33" colspan="2" align="center" class="sub_titulo_artigo_detalhes"><strong>RELATÓRIO DE TECNICOS</strong></td>
  ...
  <tr>
    ...
    <td colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      $sql_lista = "SELECT * FROM tecnicos WHERE IdUsuario = '$IdUsuario'";
