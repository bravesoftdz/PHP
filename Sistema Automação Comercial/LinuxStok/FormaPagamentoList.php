    ...
    <div id="content">
    	<div class="pg">
            ...
            <div class="bloco list" style="display:block">
            	<div class="titulo">Listagem Formas de Pagamento:<span class="btn"><a href="FormaPagamentoInsert.php">Inserir Novo</a></span>
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysql_query("SELECT * FROM formapagamento WHERE Nome LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' ORDER BY Id DESC");
						while($ResultadoSelect = mysql_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['FormaPagamento'])){
					  $Resgate = $_GET['FormaPagamento'];
					  $Delete = mysql_query("DELETE FROM formapagamento WHERE Identificador = '$Resgate'");
					  echo"<script>alert('FormaPagamento deletado com sucesso!')</script>";
                  ...
                  <tr>
                    ...
                    <td align="center"><a href="FormaPagamentoUpdate.php?FormaPagamento=<?php echo $ResultadoSelect['Identificador'] ?>" title="editar"><img src="ico/edit.png" alt="editar" title="editar" /></a></td>
                    <td align="center"><a href="FormaPagamentoList.php?FormaPagamento=<?php echo $ResultadoSelect['Identificador'] ?>" title="editar"><img src="ico/no.png" alt="excluir" title="excluir" /></a></td>
                  </tr>
                  <?php
						}
				  ?>
                ...
                <div class="paginator">
                <?php
					$ListTotal = mysql_query("SELECT Id FROM formapagamento WHERE IdUsuario = '$IdUsuario'");
