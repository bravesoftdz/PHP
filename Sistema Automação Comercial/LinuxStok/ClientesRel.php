...
?>
<title>Ver Relatório de Clientes</title>
</head>
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><div align="right"><strong class="sub_titulo_artigo_detalhes">MjERP 1.0</strong><br />
      ...
      ERP <a href="ClientesList.php">Voltar</a><br />
  ...
  <tr>
    ...
    <td height="33" colspan="2" align="center" class="sub_titulo_artigo_detalhes"><strong>RELATÓRIO DE CLIENTES</strong></td>
  ...
  <tr>
    ...
    <td colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
              ...
              <td width="23%" align="center" valign="middle" bgcolor="#f7f7f7"><strong><span class="sub_titulo_artigo">Celular:</span></strong></td>
              ...
              <td width="18%" align="center" valign="middle" bgcolor="#f7f7f7"><strong><span class="sub_titulo_artigo">CPF:</span></strong><strong><span class="sub_titulo_artigo"></span></strong></td>
      ...
      $sql_lista = "SELECT * FROM clientes WHERE IdUsuario = '$IdUsuario'";
