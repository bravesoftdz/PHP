    	...
    	<div class="pg">
            ...
            <div class="bloco form" style="display:block">
                ...
                <?php if(isset($_POST['send'])){
					...
					$Insert = mysql_query("UPDATE contaspagar SET Historico = '$Historico', ValorPago = '$ValorPago', Status = '1'  WHERE Identificador = '$Resgate'");
					echo"<script>alert('Conta a pagar baixada com sucesso!')</script>";
