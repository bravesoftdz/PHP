    ...
    <div id="content">
    	<div class="pg">
            ...
            <div class="bloco list" style="display:block">
            	<div class="titulo">Listagem Técnicos:<span class="btn"><a href="TecnicosInsert.php">Inserir Novo</a></span>
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysql_query("SELECT * FROM tecnicos WHERE Nome LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' ORDER BY Id DESC");
						while($ResultadoSelect = mysql_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['Tecnicos'])){
					  $Resgate = $_GET['Tecnicos'];
					  $Delete = mysql_query("DELETE FROM tecnicos WHERE Identificador = '$Resgate'");
					  echo"<script>alert('Tecnicos deletado com sucesso!')</script>";
                  ...
                  <tr>
                    ...
                    <td align="center"><a href="TecnicosUpdate.php?Tecnicos=<?php echo $ResultadoSelect['Identificador'] ?>" title="editar"><img src="ico/edit.png" alt="editar" title="editar" /></a></td>
                    <td align="center"><a href="TecnicosList.php?Tecnicos=<?php echo $ResultadoSelect['Identificador'] ?>" title="editar"><img src="ico/no.png" alt="excluir" title="excluir" /></a></td>
                  </tr>
                  <?php
						}
				  ?>
