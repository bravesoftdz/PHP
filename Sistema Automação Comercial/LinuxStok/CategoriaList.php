            ...
            <div class="bloco list" style="display:block">
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysql_query("SELECT * FROM categoria WHERE Nome LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' ORDER BY Id DESC");
						while($ResultadoSelect = mysql_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['Categoria'])){
					  $Resgate = $_GET['Categoria'];
					  $Delete = mysql_query("DELETE FROM categoria WHERE Identificador = '$Resgate'");
                ...
                <div class="paginator">
                <?php
					$ListTotal = mysql_query("SELECT Id FROM categoria WHERE IdUsuario = '$IdUsuario'");
