            ...
            <div class="bloco list" style="display:block">
                ...
                <table width="1000" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <?php 
						...
						$Select = mysql_query("SELECT * FROM contasreceber WHERE Identificador LIKE '%$Busca%' AND IdUsuario = '$IdUsuario' AND Status = '0' ORDER BY Id DESC");
						while($ResultadoSelect = mysql_fetch_array($Select)){
				  ?>
                  <?php if(isset($_GET['ContasReceber'])){
					  $Resgate = $_GET['ContasReceber'];
					  $Delete = mysql_query("DELETE FROM contasreceber WHERE Identificador = '$Resgate'");
