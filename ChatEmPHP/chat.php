...
if (isset($_POST)) {
    ...
    if ($logar == true) {
            ...
            <head>
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        $('#frmChat').submit(function () { //Submit do formulario
                            ...
                            $.ajax({
                                ...
                                {
                                    console.log("ERRO!!! Nao conseguiu!");
                    ...
                    function validaMensagemAjax() {
                        var enderecoRede = document.getElementById("enderecoRede").value();
                        alert('Endereco de rede: ' + enderecoRede);
                        var altura = 600;
                        $(document).ready(function () {
                            /************************ Time of answer *******************************/
                            setInterval(function () {
                            ...
                            $('#frmChat').submit(function () { //Submit do formulario
                                ...
                                $.ajax({
                                    type: "POST", // send for POST
                                    url: enderecoRede + "/script/gravar.php", //Page for where the data is sent
                                    data: dados,
                                    success: function (data, textStatus, jqXHR) { //If success...
                                        //console.log(data); // check the console log for result
                                        $("#resultado").html(data);//Show the result in div
            ...
            <body>
                <div >
                    ...
                    <form method="post" action="#" name="frmChat" id="frmChat">
                        ...
                        <br />
                        <input  type="submit" name="btnSubmit" id="btnSubmit" value="Enviar" onclick="validaMensagemAjax"/>
                        <a id="linkSair" href="sair.php"><div id="btsair">Sair</div> </a>
                        <p id="resultado"></p>
                    </form>
                    <div id="dvMensagem">
                        <label for="enderecoRede">Endereço Rede:</label>
                        <input type=Text" id="enderecoRede" value="10.1.1.1"></input>
                    </div>
                </div>
            </body>
        </html>
        ...
        header("Location:index.php?r=dados_invalidos");
    }
} else {
