...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        $SelecionaUsuario = mysqli_query($_SG['link'], "SELECT * FROM usuarios WHERE usuario = 'admin'");
        ...
        ?>
        <title>Ver Relatorio de Categorias</title>
    </head>
    <body>
        <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="center" valign="middle"><div align="right"><strong class="sub_titulo_artigo_detalhes">MjERP 1.0</strong><br />
                        ...
                        ERP <a href="CategoriaList.php">Voltar</a><br />
                        Palmas - Tocantins - Brasil</div></td>
            </tr>
            <tr>
                <td height="33" colspan="2" align="center" class="sub_titulo_artigo_detalhes"><strong>RELATORIO DE CATEGORIAS</strong></td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                    <?php
                                    $sql_lista = "SELECT * FROM categoria WHERE IdUsuario = '$IdUsuario'";
                                    ...
                                    if ($num_lista > 0) {
                                        while ($dados = mysqli_fetch_array($exe_lista)) {
                                            ...
                                            <tr class="<?php echo($i % 2) == 1 ? 'linha_a' : 'linha_b' ?>">
                                                <td width="16%" height="21" align="center" valign="middle">
                                                    <?php echo $dados['Id']; ?>
                                                </td>
